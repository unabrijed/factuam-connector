...
export const executionModes = ["upload", "connector"];
export const connectorProviders = ["kaggle", "url_csv"];
export const connectorRunStatuses = ["pending", "running", "completed", "failed"];
...
export const DataQualityReportSchema = z.object({
    ...
    inferredSchema: z.array(z.object({
        name: z.string(),
